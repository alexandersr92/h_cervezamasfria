  ...
  <div id="como_participar " class="py-20 pb-60 md:pb-20 bg-[#0033A1] relative">
    <div class="container  ">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-20 mt-20 md:w-[1000px] mx-auto items-start ">
        <img class="absolute w-[80px] md:w-[250px] -rotate-2 right-0 -bottom-10 md:left-2 md:top-80" src="<?= $floatElements[1]['image']['url'] ?>" alt="">
        <img class="absolute w-[80px] md:w-[250px] rotate-2 left-0 -bottom-10 md:left-[85%] md:top-80" src="<?= $floatElements[0]['image']['url'] ?>" alt="">
